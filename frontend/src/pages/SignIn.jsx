  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="min-w-37.5 h-12 mt-7.5 text-black font-semibold bg-white rounded-full text-[16px] " disabled={loading}>
        ...
        >
          ...
          <span className="text-[#a267da]"> Sign Up</span>
        </p>
      </form>
    </div>
  );
